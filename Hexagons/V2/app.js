 ...
 * * Updated to use .lottie format via DotLottie-web library.
 */
...
(function () {
    ...
    const ANIMATION_SECTIONS = [
        {
            ...
            animations: [
                { fileName: "From Center Purple Shapes Explosion Freeze-29.lottie" },
                { fileName: "From Center Purple Shapes Suck In Loop-25-62.lottie" },
                { fileName: "From Center Simple Freeze-25.lottie" },
                { fileName: "From Outward Shapes Suck In Loop-20-57.lottie" },
                { fileName: "From Outward Simple Freeze-20.lottie" }
            ]
        },
        {
            id: 'loaders-grid',
            ...
            animations: [
                { fileName: "Inward Loader.lottie", animationType: "continuous" },
                { fileName: "Outward Loader.lottie", animationType: "continuous" },
                { fileName: "Outward Loader Shapes Explosion.lottie", animationType: "continuous" }
            ]
        }
    ];
    ...
    class LottieCard {
        ...
        loadAnimation() {
            ...
            this.lottieAnimation = new DotLottie({
                canvas: canvas,
                src: path,
                loop: isContinuous, // Native looping for continuous
                autoplay: isContinuous // Native autoplay for continuous
            });
    ...
    function populateGrid(gridContainer, descriptionEl, cardTemplate, animations) {
        animations.forEach((animationData, index) => {
            ...
            // Cleanup title logic
            let title = animationData.fileName.replace('.lottie', '').replace('.json', '').replace(/\s\.lottie/, '').trim();
